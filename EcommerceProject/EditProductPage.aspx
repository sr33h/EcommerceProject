<%@ Page Title="" Language="C#" MasterPageFile="~/Seller.Master" AutoEventWireup="true" CodeBehind="EditProductPage.aspx.cs" Inherits="EcommerceProject.EditProductPage" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <table class="w-100">
         <tr>
             ...
             <td class="text-center">
                 <asp:Label ID="Label2" runat="server" Font-Bold="True" Font-Names="Corbel Light" Font-Size="XX-Large" ForeColor="#595757" Text="Edit Product"></asp:Label>
             </td>
             <td>&nbsp;</td>
             <td>&nbsp;</td>
         </tr>
    ...
    <table align="center" cellpadding="2" cellspacing="3" class="w-100">
        <tr>
            ...
            <td>&nbsp;</td>
            <td>
                <asp:Image ID="Image1" runat="server" Height="201px" Width="218px" />
            </td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
        </tr>
        ...
        <tr>
            ...
            <td>&nbsp;</td>
            <td>
                <asp:Button ID="Button1" runat="server" BackColor="#00CC00" Font-Bold="True" ForeColor="White" Height="46px" OnClick="Button1_Click" Text="Update" Width="123px" />
            </td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
        </tr>
